...
```typescript
import { SqliteDatabaseAdapter } from "@elizaos/runtime/adapters";
...
```typescript
import { SqlJsDatabaseAdapter } from "@elizaos/runtime/adapters";
...
```typescript
import { runAiTest } from "@elizaos/runtime/test_resources";
...
import { Plugin } from "@elizaos/runtime/types";
