class ElizaLogger {
    ...
    private constructor() {
        ...
        // Only show initialization message if not in CLI context
        const isCLI = process.argv.some(arg => arg.includes("elizaos"));
        if (!isCLI) {
...
export const logger = ElizaLogger.getInstance();
