...
export class AgentRuntime implements IAgentRuntime {
    ...
    async registerService(service: Service): Promise<void> {
        ...
        logger.log("Registering service:", serviceType);
        ...
        logger.success(`Service ${serviceType} registered successfully`);
    }
    ...
    async stop() {
        logger.debug("runtime::stop - character", this.character);
